 ...
 * $Revision: 30630 $
 * $Author: rjongbloed $
 * $Date: 2013-10-07 01:11:18 +0000 (Mon, 07 Oct 2013) $
 */
...
#define PTLIB_MINOR 13
#define PTLIB_BUILD 3
#define PTLIB_VERSION 2.13.3
...
#undef P_V8_WIN64
#undef P_V8_WIN32
#undef P_V8_NEED_ISOLATE
#undef P_V8_DEBUG_LIBS
  ...
  #if defined(_DEBUG) && defined(P_V8_DEBUG_LIBS)
...
#undef P_LIBJPEG_WIN64
  ...
  #pragma include_alias(<jpeglib.h>, </include/jpeglib.h>)

  #pragma include_alias("jconfig.h", "/include/jconfig.h")
  #pragma include_alias("jmorecfg.h", "/include/jmorecfg.h")
  ...
  #undef P_LIBJPEG_LIBRARY
    ...
    #ifdef _DEBUG
      #define P_LIBJPEG_LIBRARY "/lib/" P_LIBJPEG_BUILD "libjpeg_d.lib"
    #else
      #define P_LIBJPEG_LIBRARY "/lib/" P_LIBJPEG_BUILD "libjpeg.lib"
    #endif
  #endif
#endif
...
#undef P_IPP
  ...
  #define P_IPP_INCLUDE(inc) include_alias(<inc>, </include/inc>)
...
#undef P_GSTREAMER_WINCE
  ...
  #define P_GSTREAMER_INCLUDE(inc) include_alias(<inc>, </include/gstreamer-0.10/inc>)
  ...
  #define P_GLIB_INCLUDE(inc) include_alias(<inc>, </include/glib-2.0/inc>)
  ...
  #pragma include_alias(<glibconfig.h>, </lib/glib-2.0/include/glibconfig.h>)
  
  #define P_LIBXML_INCLUDE(inc) include_alias(<inc>, </include/libxml2/inc>)
  ...
  #pragma include_alias(<iconv.h>, </include/iconv.h>)

  #define P_GSTREAMER_LIBRARY "/lib/gstreamer-0.10.lib"
  #define P_GST_APP_LIBRARY   "/lib/gstapp-0.10.lib"
  #define P_GOBJECT_LIBRARY   "/lib/gobject-2.0.lib"
  #define P_GLIB_LIBRARY      "/lib/glib-2.0.lib"
#endif
