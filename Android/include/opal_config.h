...
#define OPAL_MAJOR 3
#define OPAL_MINOR 13
#define OPAL_BUILD 2
#define OPAL_VERSION 3.13.2

#define OPAL_CHECK_VERSION(major,minor,build) \
...
#define OPAL_G711PLC 1
  ...
  #if OPAL_RFC2435
    #if defined(_MSC_VER)
      #define JPEGLIB_LIBRARY "/../lib/jpeg.lib"
      #pragma include_alias(<jpeglib.h>, </jpeglib.h>)
    #endif
  #endif
#endif
...
#if defined(OPAL_SRTP) && defined(HAS_LIBZRTP) && !defined(_WIN32_WCE)
...
#define OPAL_JAVA 1
  ...
  #pragma include_alias(<jni.h>,    <d:/workspace/tools/android-ndk-r9c/platforms/android-14/arch-arm/usr/include/jni.h>)
  #pragma include_alias("jni_md.h", "d:/workspace/tools/android-ndk-r9c/platforms/android-14/arch-arm/usr/include/win32/jni_md.h")
#endif
...
//
  ...
  #undef OPAL_RUBY
    ...
    #pragma include_alias(<ruby.h>, </ruby.h>)
    #pragma include_alias("ruby/config.h", "/i386-mswin32/ruby/config.h")
    #pragma include_alias("ruby/io.h", "/ruby/io.h")
    #pragma include_alias("ruby/encoding.h", "/ruby/encoding.h")
    #pragma include_alias("ruby/oniguruma.h", "/ruby/oniguruma.h")

    #define RUBY_LIBRARY "/../../lib/msvcrt-ruby191.lib"
  #endif
