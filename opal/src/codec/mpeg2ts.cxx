...
inline Ipp16u GET_16U(const Ipp8u* p) { return (((Ipp16u)p[0])<<8) | p[1];}
...
int Mpeg2TS::Stream::process(const Ipp8u* data, int iPos)
{
    if (_inFrameSize == 0) {
...
int Mpeg2TS::Stream::parsePSE(const Ipp8u* data, int iPos)
{
    _inFrameSize = _frameSize = 0;
    ...
    const Ipp8u* pesPacket = data + iPos;
    ...
    Ipp16u PES_packet_len = GET_16U(&pesPacket[4]);
...
void Mpeg2TS::dispatchPacket(const Ipp8u* data)
{
    int iPos = 0;
...
void Mpeg2TS::videoFrame(Ipp8u* frame, Ipp32u frameSize)
{
...
void Mpeg2TS::audioFrame(Ipp8u* frame, Ipp32u frameSize)
{
