...
#ifndef __H264_DINSK__
#define __H264_DINSK__ 1
...
#include "codec/h264_enc/include/umc_h264_video_encoder.h"
#include "codec/h264_dec/include/umc_h264_dec.h"

class H264EncoderContext : public UMC::H264VideoEncoder
{
  public:
    H264EncoderContext ();
    ~H264EncoderContext ();
...
class H264DecoderContext  : public UMC::H264VideoDecoder
{
  public:
    H264DecoderContext();
    ~H264DecoderContext();
...
// H.264 SCIF
static const char     H264SQCIF_Desc[]          = { "H.264-DINSK-SQCIF" };
static const char     H264SQCIF_MediaFmt[]      = { "H.264-DINSK-SQCIF" };                             
...
// H.264 QCIF
static const char     H264QCIF_Desc[]          = { "H.264-DINSK-QCIF" };
static const char     H264QCIF_MediaFmt[]      = { "H.264-DINSK-QCIF" };                             
...
// H.264 CIF
static const char     H264CIF_Desc[]          = { "H.264-DINSK-CIF" };
static const char     H264CIF_MediaFmt[]      = { "H.264-DINSK-CIF" };                             
...
static const char     H264CIF4_Desc[]          = { "H.264-DINSK-4CIF" };
static const char     H264CIF4_MediaFmt[]      = { "H.264-DINSK-4CIF" };                             
...
// H.264 720P
static const char     H264720P_Desc[]          = { "H.264-DINSK-720P" };
static const char     H264720P_MediaFmt[]      = { "H.264-DINSK-720P" };                             
