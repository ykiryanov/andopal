 ...
 * $Revision: 31235 $
 * $Author: rjongbloed $
 * $Date: 2014-01-20 03:57:41 +0000 (Mon, 20 Jan 2014) $
 */
...
{
  PTRACE(3, "OpalCon\tGetMediaTransportAddresses of " << mediaType << " could not find transports for " << otherConnection << " on " << *this);
  return false;
}
