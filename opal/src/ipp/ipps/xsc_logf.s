...
LABN7:
        ...
        add     lr, lr, r6, asr r7
        rsb     r7, r7, #0x20
        and     r6, r6, r12, lsr r7
        str     r6, [sp]
        rsblt   r1, r1, #0x2A
        addlt   r0, r0, r6, lsl r1
        subge   r1, r1, #0x2A
        addge   r0, r0, r6, asr r1
LABN8:
        rsb     r1, r2, #0x2A
        add     r1, lr, r0, asr r1
        adds    lr, r1, r1, lsr #31
        eor     r0, lr, lr, asr #31
        sub     r1, r0, lr, asr #31
        clz     r5, r1
        add     r2, r2, r5
...
LABN13:
        add     sp, sp, #8
        ldmia   sp!, {r4 - r9, pc}
        .long   LABN_sgl_table_1ov1pjov16
        .long   LABN_sgl_table_log1pjby16
        .long   LABN_sgl_table_scale_log1pjby16
        .long   0xeaa2199c
        .long   0x19a1a9aa
        .long   0x2aaaa9e1
        .long   0x58b90bfc
...
LABN_sgl_table_scale_log1pjby16:
