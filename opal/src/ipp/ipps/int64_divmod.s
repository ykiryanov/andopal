...
LAGL_SMALL_B_OR_Q:
        cmp     r3, #0
        bne     LAGL_SMALL_Q_LARGE_B
        clz     r4, r2
        rsbs    r5, r2, #4
        cmpcc   r2, #2, 8
        rsbccs  r5, r1, #0
        bcs     LAGL_SMALL_MED_B_OR_SMALL_A
        mov     r3, r2, lsl r4
        ...
        ldmia   sp!, {r4 - r11}
        bx      lr
LAGL_SMALL_MED_B_OR_SMALL_A:
        cmp     r2, #5
        cmpcs   r1, #1
        bcc     LAGL_VERY_SMALL_B_OR_SMALL_A
        mov     r6, #0
        cmp     r2, r1, lsr #6
...
LAGL_SMALL_Q_LARGE_B:
        ...
        ldmia   sp!, {r4 - r11}
        bx      lr
LAGL_VERY_SMALL_B_OR_SMALL_A:
        cmp     r2, #5
        bcc     LAGL_VERY_SMALL_B
        mov     r7, r2, lsl r4
