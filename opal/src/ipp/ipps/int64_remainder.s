...
LAGQ_SMALL_B_OR_Q:
        cmp     r3, #0
        bne     LAGQ_SMALL_Q_LARGE_B
        clz     r4, r2
        rsbs    r5, r2, #4
        cmpcc   r2, #2, 8
        rsbccs  r5, r1, #0
        bcs     LAGQ_SMALL_MED_B_OR_SMALL_A
        mov     r3, r2, lsl r4
        ...
        ldmia   sp!, {r4 - r11}
        bx      lr
LAGQ_SMALL_MED_B_OR_SMALL_A:
        cmp     r2, #5
        cmpcs   r1, #1
        bcc     LAGQ_VERY_SMALL_B_OR_SMALL_A
        mov     r5, r2, lsl r4
...
LAGQ_SMALL_Q_LARGE_B:
        ...
        ldmia   sp!, {r4 - r11}
        bx      lr
LAGQ_VERY_SMALL_B_OR_SMALL_A:
        cmp     r2, #5
        bcc     LAGQ_VERY_SMALL_B
        cmp     r2, r0, lsr #16
        bhi     LAGQ_SHORT_Q
        cmp     r2, r0, lsr #31
