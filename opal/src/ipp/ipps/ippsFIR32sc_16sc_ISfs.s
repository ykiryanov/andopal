        .text
        .align  4
        .globl  _ippsFIR32sc_16sc_ISfs


_ippsFIR32sc_16sc_ISfs:
        stmdb   sp!, {r4 - r11, lr}
        sub     sp, sp, #0x1C
        mov     r4, r2
        cmp     r4, #0
...
LBUZ7:
        ...
        add     sp, sp, #0x1C
        ldmia   sp!, {r4 - r11, lr}
        b       LBUZ_ownsFIRMR32sc_16sc_ISfs
LBUZ8:
        mvn     r0, #5
        add     sp, sp, #0x1C
        ldmia   sp!, {r4 - r11, pc}
...
LBUZ16:
        ...
        mov     r2, r7
        mov     r1, r4
        bl      LBUZ_ownsFIRMR_16sc_Sfs
        mov     r0, r4
        bl      _ippsFree
        mov     r0, #0
        add     sp, sp, #0x50
        ldmia   sp!, {r4 - r11, pc}
LBUZ_ownsFIRMR_16sc_Sfs:
        stmdb   sp!, {r4 - r11, lr}
        sub     sp, sp, #0x34
        mov     r6, r0
        ldr     lr, [r6, #0x10]
