...
__divdi3:
        ...
        cmp     r3, #0
        mov     r8, r3
        bpl     LAGR_DIV_CONTINUE
        rsbs    r2, r2, #0
        rsc     r3, r3, #0
LAGR_DIV_CONTINUE:
        cmp     r1, #0
        bpl     LAGR_DIV_CONTINUE2
        eor     r8, r8, #2, 2
        rsbs    r0, r0, #0
        rsc     r1, r1, #0
LAGR_DIV_CONTINUE2:
...
LAGR_SMALL_B_OR_Q:
        cmp     r3, #0
        bne     LAGR_SMALL_Q_LARGE_B
        clz     r4, r2
        rsbs    r5, r2, #4
        cmpcc   r2, #2, 8
        rsbccs  r5, r1, #0
        bcs     LAGR_SMALL_MED_B_OR_SMALL_A
        mov     r3, r2, lsl r4
        ...
        ldmia   sp!, {r4 - r8}
        bx      lr
LAGR_SMALL_MED_B_OR_SMALL_A:
        cmp     r2, #5
        cmpcs   r1, #1
        bcc     LAGR_VERY_SMALL_B_OR_SMALL_A
        mov     r5, r2, lsl r4
...
LAGR_SMALL_Q_LARGE_B:
        ...
        ldmia   sp!, {r4 - r8}
        bx      lr
LAGR_VERY_SMALL_B_OR_SMALL_A:
        cmp     r2, #5
        bcc     LAGR_VERY_SMALL_B
        mov     r3, r2, lsl r4
        ldrb    r12, [r12, +r3, lsr #25]
        cmp     r2, r0, lsr #7
        bhi     LAGR_SHORT_Q
