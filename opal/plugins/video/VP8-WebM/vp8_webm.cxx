 ...
 * $Revision: 31063 $
 * $Author: rjongbloed $
 * $Date: 2013-12-11 01:23:44 +0000 (Wed, 11 Dec 2013) $
 */
...
class VP8Encoder : public PluginVideoEncoder<VP8_CODEC>
{
  ...
  public:
    ...
    virtual bool Construct()
    {
      ...
      PTRACE(4, MY_CODEC_LOG, "Encoder opened: " << vpx_codec_version_str() << ", revision $Revision: 31063 $");
      return true;
    }
...
class VP8Decoder : public PluginVideoDecoder<VP8_CODEC>
{
  ...
  public:
    ...
    virtual bool Construct()
    {
      ...
      PTRACE(4, MY_CODEC_LOG, "Decoder opened: " << vpx_codec_version_str() << ", revision $Revision: 31063 $");
      return true;
    }
