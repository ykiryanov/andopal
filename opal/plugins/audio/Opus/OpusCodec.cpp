 ...
 * $Revision: 31042 $
 * $Author: rjongbloed $
 * $Date: 2013-12-05 23:46:19 +0000 (Thu, 05 Dec 2013) $
 */
...
class OpusPluginEncoder : public OpusPluginCodec
{
  ...
  public:
    OpusPluginEncoder(const PluginCodec_Definition * defn)
      ...
      , m_bitRate(12000)
    {
      PTRACE(4, MY_CODEC_LOG, "Encoder created: $Revision: 31042 $, version \"" << opus_get_version_string() << '"');
    }
...
class OpusPluginDecoder : public OpusPluginCodec
{
  ...
  public:
    OpusPluginDecoder(const PluginCodec_Definition * defn)
      ...
      , m_decoder(NULL)
    {
      PTRACE(4, MY_CODEC_LOG, "Decoder created: $Revision: 31042 $, version \"" << opus_get_version_string() << '"');
    }
